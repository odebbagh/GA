...
Case of 
	: (FORM Event:C1606.code=On Load:K2:1)
		...
		OBJECT SET COORDINATES:C1248(*; "lb_communications"; $lb_left; $lb_top; $widthSubform; $heightSubform)
		...
		OBJECT SET COORDINATES:C1248(*; "communication_bkgd"; $cb_left; $cb_top; $widthSubform; $heightSubform)
...
If (Form:C1466#Null:C1517)
	// a parent can bind {readOnly: true} to display the list without edit actions
	OBJECT SET VISIBLE:C603(*; "bActions"; Not:C34(Bool:C1537(Form:C1466.readOnly)))
End if
