...
If ((FORM Event:C1606.code=On Data Change:K2:15) | (FORM Event:C1606.code=On Losing Focus:K2:8))
	...
	Form:C1466.stepInterruptionStartTimeDisplay:=cs:C1710.panel_punch_out.me.formatInterruptionTimeOnLosingFocus(Form:C1466.stepInterruptionStartTimeDisplay)
