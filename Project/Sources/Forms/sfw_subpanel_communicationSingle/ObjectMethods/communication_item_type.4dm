...
If ($isInModification)
	...
	For each ($type; $contactTypes)
		...
		If ($type.type=Form:C1466.communication.type)
	...
	Case of 
		...
		Else 
			Form:C1466.communication.type:=$choose
			//READ PICTURE FILE("RESOURCES\\image\\skin\\contactType\\"+$choose+".png"; $Picture)
			//Form.communication.icon:=$Picture
			Form:C1466.communication.contact:=""
			
	End case 
End if 

OBJECT SET FORMAT:C236(*; "communication_item_type"; Form:C1466.communication.type+";#image/skin/contactType/"+Form:C1466.communication.type+".png;0;3;1;1;8;0;0;0;1;0;1")