Case of 
	: (FORM Event:C1606.code=On Getting Focus:K2:7) | (FORM Event:C1606.code=On Clicked:K2:4)
		...
		OBJECT GET COORDINATES:C663(*; "Field_stepFileName"; $l; $t; $r; $b)
		CONVERT COORDINATES:C1365($l; $b; XY Current form:K27:5; XY Main window:K27:8)
		
		$form:=New object:C1471(\
			"colName"; "name"; \
			"allData"; ds:C1482.StepFile.query("UUID_Customer = :1"; Form:C1466.lotInfo.customer.UUID); \
			"dataclass"; "StepFile"\
			)
