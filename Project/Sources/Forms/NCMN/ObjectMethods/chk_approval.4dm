Case of 
	: (FORM Event:C1606.code=On Clicked:K2:4)
		...
		Case of 
			: (FORM Event:C1606.objectName="chk_customer_service")
				$approvalField:="approvalCustomerService"
				$dateField:="dateCustomerService"
				$profileIdent:="cs"
				$profileLabel:="Customer Service"
			: (FORM Event:C1606.objectName="chk_engineering")
				$approvalField:="approvalEngineering"
				$dateField:="dateEngineering"
				$profileIdent:="Eng"
				$profileLabel:="Engineering"
			: (FORM Event:C1606.objectName="chk_qa_qc")
				$approvalField:="approvalQAQC"
				$dateField:="dateQAQC"
				$profileIdent:="Q"
				$profileLabel:="QA/QC"
			: (FORM Event:C1606.objectName="chk_production")
				$approvalField:="approvalProduction"
				$dateField:="dateProduction"
				$profileIdent:="p"
