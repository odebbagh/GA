...
Function displayQASignoffSection()
	...
	OBJECT SET VISIBLE:C603(*; "dates_bkgd5"; $show)
	OBJECT SET VISIBLE:C603(*; "dates_header5"; $show)
	OBJECT SET VISIBLE:C603(*; "label_punch_in_section5"; $show)
...
Function displayDetailForm()
	...
	OBJECT SET ENABLED:C1123(*; "df_field@"; Form:C1466.sfw.checkIsInModification())
	OBJECT SET VISIBLE:C603(*; "df_btnDatePicker@"; Form:C1466.sfw.checkIsInModification())
...
Function displayConsumedPartsDF()
	...
	OBJECT SET ENABLED:C1123(*; "cp_df_field_quantity"; Form:C1466.sfw.checkIsInModification())
...
Function displaySerializationDetailForm()
	...
	OBJECT SET ENABLED:C1123(*; "sn_checkbox_pass"; Form:C1466.sfw.checkIsInModification())
	OBJECT SET ENABLED:C1123(*; "sn_field_description_entryField"; Form:C1466.sfw.checkIsInModification())
...
Function bActionDataTable()
	...
	$isModification:=Form:C1466.sfw.checkIsInModification()
