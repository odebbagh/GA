...
Case of 
	...
	Else 
		...
		$form.callbacks:=cs:C1710.sfw_documentationEntryDefinition.me.functions.copy()
		...
		If (ok=1)
			...
			$show:=cs:C1710.sfw_dialog.me.confirm("Would you like to display the comment in the code ? "; "yes"; "no")
