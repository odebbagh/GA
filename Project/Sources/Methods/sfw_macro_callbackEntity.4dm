...
Case of 
	...
	: ($method_path#"@Entity")
		cs:C1710.sfw_dialog.me.alert("You aren't in a class who extend a dataclass entity")
	...
	Else 
		...
		$form.callbacks:=cs:C1710.sfw_documentationEntityCallback.me.callbacks.copy()
