...
LIST TO ARRAY:C288("Operation Type"; $items; $refs)
...
$file:=$exportsFolder.file("operations_export.json")
...
ALERT:C41("Export termine: "+$file.platformPath+" | operations: "+String:C10($records.length))
