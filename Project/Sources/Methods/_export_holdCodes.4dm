...
// Export from old enumeration Hold_Codes.
LIST TO ARRAY:C288("Hold_Codes"; $items; $refs)
...
$file:=$exportsFolder.file("holdCodes_export.json")
...
ALERT:C41("Export termine: "+$file.platformPath+" | hold codes: "+String:C10($records.length))
