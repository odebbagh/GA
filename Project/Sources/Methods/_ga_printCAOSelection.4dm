...
/*
Method Name : _ga_printCAOSelection
Author : Medard /4D PS
Date : 23-Jan-2025
Purpose : Print CAO Selection 
*/
...
If (Form:C1466.sfw.lb_items.length>0)
	...
	$file:=Folder:C1567(fk resources folder:K87:11).file("4DWriteProPrintTemplates/CAOPrintSelection.4wp")
