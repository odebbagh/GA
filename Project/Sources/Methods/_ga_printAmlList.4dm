...
/*
Method Name : _ga_printAmlList
Author : Medard /4D PS
Date : 11-August-2025
Purpose : Print AML Selection 
*/
...
If (Form:C1466.sfw.lb_items.length>0)
	...
	$context.partNum:=Form:C1466.current_item.ourPartNum  //_ga_getListFiltersValues("PartData"; "UUID"; "internalPartNum")
